<div class="container-fluid">
    ...
    <form method="POST" class="user">
        ...
        <input type="number" name="id_mapel" class="form-control form-control-user formlogin" id="" hidden>

        <div class="form-group">
            <label for="text">Nama Mata Pelajaran</label>
            <input type="text" name="nama_mapel" class="form-control form-control-user formlogin" id="" required>
        </div>
    ...
    if (isset($_POST['btSimpan'])){
        ...
        $result = mysqli_query($koneksi, "SELECT id_mapel FROM tbmapel WHERE id_mapel = '$idMapel' ");
        ...
        $querysimpan = "INSERT INTO `tbmapel` (`id_mapel`, `nama_mapel`) 
