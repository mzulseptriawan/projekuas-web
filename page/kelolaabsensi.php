<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kelola Absensi Guru</h1>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                include '../koneksi.php';
                                $no = 1;
                                $tampilguru = $koneksi -> query("SELECT `tbabsen`.`nip`,`tbabsen`.`id_absen`, `tbabsen`.`tgl_absen`, 
                                ...
                                while($row = $tampilguru -> fetch_array()){
                                    ...
                                    <td><a href='hapusabsensi.php?id=".$row['id_absen']."'>Hapus</a></td>
