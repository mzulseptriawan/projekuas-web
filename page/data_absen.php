<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Jadwal Mengajar Guru</h1>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                $no = 1;
                                $tampilguru = $koneksi -> query("SELECT tbguru.nip , tbguru.nama , tbmapel.nama_mapel, tbkelas.nama_kelas, tbabsenn.tgl_absen, tbabsenn.waktu_absen, tbabsenn.keterangan, tbabsenn.foto FROM tbabsenn INNER JOIN tbjadwal ON tbabsenn.id_jadwal = tbjadwal.id_jadwal INNER JOIN tbmapel ON tbjadwal.id_mapel = tbmapel.id_mapel INNER JOIN tbkelas ON tbjadwal.id_kelas = tbkelas.id_kelas INNER JOIN tbguru ON tbjadwal.nip = tbguru.nip WHERE tbjadwal.nip = '".$_SESSION['nip']."' ");
